...
<html>
  <head>
    ...
    <script src="static/js/jquery-1.3.2.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="static/js/motif.js" type="text/javascript" charset="utf-8"></script>
		
		{% block extrahead %}

		{% endblock %}
		
    <link rel="stylesheet" href="static/css/trends-general.css" type="text/css" media="screen" title="no title" charset="utf-8"/>
  </head>
  <body>  
    {% block content %}
