...
Rather than the flat list of results commonly presented in Web search, we opted for a user interface inspired by faceted search, which has been shown to aid Web search tasks. \mikeyk{cite http://portal.acm.org/citation.cfm?id=567525}. This allows users to explore the breadth of related themes that might appear for a given search query.
...
In the blog and microblog search domain, much of the work on search has focused on its applications and unique characteristics relative to traditional Web search, though some work focuses on improving the search engine  itself. This work includes research that uses temporal data for clustering \mikeyk{cite: http://portal.acm.org/citation.cfm?id=1645953.1645968}, or applies information visualization techniques to aid search \mikeyk{ citation in comments below }.

% http://scholar.google.com/scholar.bib?q=info:-YwvIrwhSvYJ:scholar.google.com/&output=citation&hl=en&as_sdt=2000&ct=citation&cd=3 ~mikeyk
